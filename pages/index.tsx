    ...
    <>
      ...
      <main className="px-4 max-w-6xl mx-auto py-12 space-y-24">
        ...
        <section className="text-center space-y-6">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#007BFF]">
            Grow Your Socials with YesViral
          </h1>
        ...
        <section id="about" className="text-center space-y-4">
          <h2 className="section-title">Why YesViral?</h2>
          <p className="section-subtext">
            We’re not just another panel — we’re a full-scale growth engine for creators and brands.
            Trusted by thousands for fast, high-retention results that boost real visibility.
          </p>
        </section>
        ...
        <section id="how-it-works" className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-4xl mb-2 text-[#007BFF] font-bold">1</div>
            ...
            <div>
              <div className="text-4xl mb-2 text-[#007BFF] font-bold">2</div>
            ...
            <div>
              <div className="text-4xl mb-2 text-[#007BFF] font-bold">3</div>
        ...
        <section className="text-center space-y-3 mt-16">
          ...
          <p className="section-subtext">Start growing your brand today — pick a service and see instant results.</p>
          <Link href="/checkout">
            <button className="btn-primary">Choose a Service</button>
          </Link>
        </section>
      </main>
    </>
