...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "No, never. We do not require your password for any of our services. Everything is delivered securely without accessing your account.",
  },
  {
    question: "Are the followers, likes, and subscribers real?",
    answer:
      "Yes. We don’t use bots or fake accounts. All engagement comes from real users, helping your account grow naturally.",
  },
  {
    question: "Is your service safe and legal?",
    answer:
      "Absolutely. We use safe, secure, and compliant methods. Your account stays 100% protected.",
  },
  {
    question: "What is your refill guarantee?",
    answer:
      "Our 30-day refill guarantee means any drops within 30 days will be refilled completely free.",
  },
];
...
const SERVICES = [
  ...
  },
  {
    ...
    key: "tiktok",
    price: "$0.08 / 100",
    description: ["✨ High-impact Likes & Views", "🚀 Instant Order Start", "🙅‍♂️ No Login Needed", "🛡️ Protected Service"],
  ...
  },
  {
    ...
    key: "youtube",
    price: "$0.05 / 1000",
    description: ["🏆 Premium Views & Watch time", "📈 Boosts Channel Performance", "🤫 Private Delivery", "🤖 Algorithm Friendly"],
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Grow your social media with YesViral. Buy real followers, likes, views, and more — fast, secure, and trusted." />
      </Head>
      ...
      <main className="px-4 sm:px-6 max-w-7xl mx-auto py-4 sm:py-8 space-y-6 md:space-y-10 select-none">
        ...
        <section className="relative flex flex-col-reverse md:grid md:grid-cols-2 md:gap-8 items-center">
          ...
          <div className="w-full flex flex-col items-center md:items-start space-y-7 text-center md:text-left">
            ...
            <p className="text-[#444] text-base sm:text-lg max-w-md sm:max-w-xl font-medium">
              Unlock Social Growth with YesViral — Trusted by Creators and Brands for High-Quality services powered by Exclusive Private Networks.
            </p>
            ...
            <span className="text-xs text-[#555] font-medium">🔒 SSL-encrypted · ⭐ 4.8/5 rating · ⚡ Orders start in minutes</span>
          </div>

          {/* RIGHT SIDE — FIXED, CARDS CLOSER */}
          <div className="relative hidden md:flex items-center justify-center">
            <div className="relative inline-block">

              {/* TOP ROW (closer) */}
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex flex-nowrap gap-3">
                <div className="bg-white/95 border border-[#CFE4FF] rounded-xl px-4 py-2 shadow-lg flex items-center gap-2 yv-card-1 whitespace-nowrap">
                  <span className="text-[#007BFF] text-lg">💙</span>
                  <p className="text-[13px] font-semibold text-[#111]">Trusted by Brands & Creators</p>
                </div>

                <div className="bg-white/95 border border-[#CFE4FF] rounded-xl px-4 py-2 shadow-lg flex items-center gap-2 yv-card-2 whitespace-nowrap">
                  <span className="text-[#007BFF] text-lg">📦</span>
              ...
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 flex flex-nowrap gap-3">
                <div className="bg-white/95 border border-[#CFE4FF] rounded-xl px-4 py-2 shadow-lg flex items-center gap-2 yv-card-3 whitespace-nowrap">
                  <span className="text-[#007BFF] text-lg">🔒</span>
                  <p className="text-[13px] font-semibold text-[#111]">Private Delivery Networks</p>
                </div>

                <div className="bg-white/95 border border-[#CFE4FF] rounded-xl px-4 py-2 shadow-lg flex items-center gap-2 yv-card-4 whitespace-nowrap">
                  <span className="text-[#007BFF] text-lg">⚡</span>
              ...
              {/* PHONE IMAGE */}
              <Image src="/hero-illustration.png" alt="YesViral Notifications Illustration" width={420} height={420} className="w-full max-w-[420px] h-auto object-contain drop-shadow-2xl" draggable={false} priority />
            </div>
          </div>
        ...
        <section id="order" className="space-y-7 py-8 md:py-14">
          ...
          <p className="text-[#444] text-center max-w-2xl mx-auto">Choose your service — <span className="text-[#007BFF] font-semibold">Instant delivery starts within minutes.</span></p>
          ...
          <div className="flex justify-center gap-1 mb-6">
            ...
            <span className="ml-2 text-[#007BFF] font-semibold text-sm">4.8 / 5 rating</span>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map(({ name, price, description, icon, tag, count, key }, idx) => (
              <div key={idx} className="bg-white border-2 border-[#CFE4FF] rounded-2xl p-7 shadow-md hover:shadow-2xl transition flex flex-col gap-3 relative">
                ...
                <ul className="text-sm text-[#444] pl-5 list-disc space-y-1">{description.map((p, i) => <li key={i}>{p}</li>)}</ul>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-[#007BFF] font-medium text-sm">{price}</span>
                  <span className="text-xs bg-[#E8F1FF] text-[#111] px-2 py-0.5 rounded">{count}</span>
                </div>
                <button className="mt-4 w-full bg-[#007BFF] text-white text-sm px-4 py-2 rounded-lg font-bold hover:bg-[#005FCC] shadow transition" onClick={() => openOrderModalService(key)}>Order</button>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="about" className="bg-[#F5FAFF] p-8 md:p-12 rounded-2xl text-center shadow-sm space-y-8">
          ...
          <div className="flex flex-wrap gap-7 justify-center">
            <div className="flex flex-col items-center max-w-[170px]"><Zap className="text-[#007BFF]" size={32} /><span className="font-semibold mt-2">Instant Start</span><span className="text-sm text-[#444]">1–10 min</span></div>
        ...
        <section className="text-center space-y-4 py-6">
          ...
          <p className="text-[#444] text-lg">Join over 100,000+ creators already growing with YesViral.</p>
