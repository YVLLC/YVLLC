...
const MEGA_MENUS = {
  ...
  tiktok: [
    ...
    },
    {
      ...
      desc: "Get Videos Trending with High-Quality likes.",
    },
    {
  ...
  youtube: [
    ...
    },
    {
      ...
      desc: "Premium Like Boosts for every Video.",
    },
    {
...
export default function Header() {
  ...
  return (
    <header className="bg-white border-b border-[#CFE4FF] sticky top-0 z-50 shadow-sm w-full">
      {/* FIX FOR ALL DEVICES: prevents rare overflow on ultra-small screens */}
                  ...
                  <div className="flex flex-col gap-1">
                    {MEGA_MENUS[tab.key as MegaKey].map((item) => (
                      ...
                      >
                        <span>{item.icon}</span>
                        <span>
                          <span className="font-semibold text-[#007BFF] group-hover:underline">
                            {item.name}
                          </span>
